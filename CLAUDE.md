...
MaxDock is a static GitHub Pages dock-appointment application backed by Supabase Auth, Postgres/RLS/RPCs, and two Supabase Edge Functions. The current production release is DB39, built on the DB31 through DB39 interface and scheduling refinements; DB40 is the active reviewed release branch.
...
- Current UI refinement layers: `maxdock-db31-base.css`, `maxdock-db33.css`, `maxdock-db34.css`, `maxdock-db35.css`, `maxdock-db36.css`, `maxdock-db38.css`, `maxdock-db39.css`, `maxdock-db40.css`, `maxdock-ops-density.js`, `maxdock-layout-discipline.js`.
