(function(){
  ...
  function getLandingPage(roleCode=state.profile?.role_code){
    if(["shipping_manager","coordinator"].includes(roleCode))return "queue.html?v=64-db43";
    if(["system_admin","site_admin"].includes(roleCode))return "dashboard.html?v=64-db43";
    return "index.html?v=64-db43";
  }
  ...
  function addAccountControls(){
    ...
    const bell=document.createElement("a");bell.id="maxdockNotificationBell";bell.className="notificationBell";bell.href="./my-appointments.html?v=64-db43";bell.title="Open notifications";bell.setAttribute("aria-label","Open notifications");
