MaxDock v46-DB11 — Operational Features Build
...
- Automated email delivery remains disabled until a production email provider is connected; DB11 records email-ready notification data without claiming delivery.
