(function(){
  ...
  function getLandingPage(roleCode=state.profile?.role_code){
    if(["shipping_manager","coordinator"].includes(roleCode))return "queue.html?v=46-db17";
    if(["system_admin","site_admin"].includes(roleCode))return "dashboard.html?v=46-db17";
    return "index.html?v=46-db17";
  }
  ...
  function addAccountControls(){
    ...
    const bell=document.createElement("a");bell.id="maxdockNotificationBell";bell.className="notificationBell";bell.href="./my-appointments.html?v=46-db17";bell.title="Open notifications";bell.setAttribute("aria-label","Open notifications");
